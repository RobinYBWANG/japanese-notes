...
WHEN = [{'w': '明日', 'k': 'あした', 'zh': '明天'}, {'w': '昨日', 'k': 'きのう', 'zh': '昨天'},
        {'w': '週末', 'k': 'しゅうまつ', 'zh': '週末'}, {'w': 'あとで', 'k': 'あとで', 'zh': '等一下'}]
...
T = {
    ...
    5: [
        ...
        ('① ［場所］へ 行きます', '{when}回老家', '{when} 実家へ 帰ります', {'when': WHEN}),
        ('② どこへ 行きますか', '{when}要去哪裡？', '{when} どこへ 行きますか', {'when': WHEN}),
        ('② どこへ 行きますか', '昨天去了哪裡？', '昨日 どこへ 行きましたか', None),
        ...
        ('⑦ 時間＋場所へ', '{when}去{dest}', '{when} {dest}へ 行きます', {'when': WHEN, 'dest': DEST}),
...
REPL = [('誰の', 'だれの'), ('何の', 'なんの'), ('何歳', 'なんさい'), ('何時', 'なんじ'),
        ('飛行機で', 'ひこうきで'), ('電車に', 'でんしゃに'), ('友達が', 'ともだちが'), ('帰りました', 'かえりました'), ('帰ります', 'かえります'),

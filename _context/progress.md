...
- **五十音已獨立成 `kana.html`(2.0MB,2026-08-22)**,首頁第一張卡;minna-notes 當時瘦到 16.3MB,現在又長到 28.9MB。
- `n5-vocab.html`:**892 字**,全面改用 VOICEVOX 冥鳴ひまり(14)預錄音檔(1725 clips,6.8MB),
  音調圖已移除。是第二個「有內嵌音檔」的檔案。
- 語音包:minna-notes say 2173 / audio 6519 clips(檔案 **28.9MB** — 音檔外置該做了);kana.html say 393 / audio 1179 clips。
...
- **minna-notes 已 40MB**(動詞小抽考「加入單字」整句音檔 1650 clips 就 +8.4MB);使用者 2026-09-11 決定先照現狀,音檔外置仍在 todo。

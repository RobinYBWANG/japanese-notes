...
- 筆記內容:第1課〜第12課架構,**L1〜L5 完整**(單字/文法/小考/朗讀/測驗)+數字/量詞/時間表;**L6 只有課名＋單字 71 字**(2026-09-11,課本 48＋会話 2＋手寫補充 21,音檔已補)。
...
- 第6課接著補文法→小考→朗讀→測驗(單字已進,照 CLAUDE.md「課程更新的連帶工作」);第7課起同樣流程。

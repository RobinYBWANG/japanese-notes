...
def rtmpl6(rows, rng):
    c = rng.choice
    # 一套 22 行＝下面 16 條剛好取完一輪（後面的樣板永遠輪不到，所以不多放）。
    ...
    return [
        ...
        lambda: [c(WHEN6_P) + ' ' + c(BUY6) + 'を 買いました。'],
        lambda: ['毎日 ' + c(DRINK6) + 'を 飲みます。'],
        lambda: c([['私は ' + c(READ6) + 'を 読みます。'], ['音楽を 聞きます。'], ['手紙を 書きます。'],
                   ['写真を 撮ります。'], ['たばこを 吸いません。']]),
        lambda: ['A: 日本語を 勉強しますか。', 'B: はい、勉強します。'],
        lambda: ['私は 何も 食べません。'],
        lambda: [c(WHEN6_P) + ' 何も 食べませんでした。'],
        lambda: [c(WHEN6_F) + ' どこへも 行きません。'],
        lambda: ['私は なんでも 食べます。'],
        lambda: ['誰も 来ません。'],
        lambda: ['誰でも 分かります。'],

...
# 第7課：道具の で／語言の で／〜に あげます・もらいます／もう〜ましたか。
TOOL7 = ['はし', 'スプーン', 'ナイフ', 'フォーク', 'はさみ', 'パソコン']
EAT7 = ['はし', 'スプーン', 'ナイフ', 'フォーク']          # 吃飯只能用餐具（不能「パソコンで 食べます」）
FLANG7 = ['英語', '中国語']                              # 問「ありがとう」怎麼說時不能用日本語（會變成問自己）
LANG7 = ['日本語', '英語', '中国語']
PERSON7 = ['友達', '先生', '彼', '会社の 人', '娘']
GIFT7 = ['プレゼント', '花', '年賀状', 'シャツ', '本', 'チョコレート']
DONE7 = ['荷物を 送り', 'プレゼントを 買い', '宿題を し', '昼ごはんを 食べ', 'メールを 送り']
# 上課補充：に（單向）／と（對等）／を（把對方當對象）
TOGETHER7 = ['ごはんを 食べます', 'テレビを 見ます', '会話します', '結婚します']
...
def rtmpl7(rows, rng):
    ...
    return [
        lambda: ['A: 何で ごはんを 食べますか。', 'B: ' + c(EAT7) + 'で 食べます。'],
        lambda: ['私は ' + c(EAT7) + 'で ごはんを 食べます。'],
        lambda: ['A: 「ありがとう」は ' + c(FLANG7) + 'で 何ですか。', 'B: 分かりません。'],
        lambda: [c(LANG7) + 'で レポートを 書きます。'],
        lambda: ['A: だれに ' + c(GIFT7) + 'を あげますか。', 'B: ' + c(PERSON7) + 'に あげます。'],
        lambda: ['私は ' + c(PERSON7) + 'に ' + c(GIFT7) + 'を あげました。'],
        lambda: ['A: だれに ' + c(GIFT7) + 'を もらいましたか。', 'B: ' + c(PERSON7) + 'に もらいました。'],
        lambda: ['私は ' + c(PERSON7) + 'に ' + c(GIFT7) + 'を もらいました。'],
        lambda: (lambda d: ['A: もう ' + d + 'ましたか。', 'B: はい、もう ' + d + 'ました。'])(c(DONE7)),
        lambda: ['A: もう ' + c(DONE7) + 'ましたか。', 'B: いいえ、まだです。'],
        lambda: c([['先生に 日本語を 習いました。'], ['銀行から お金を 借ります。'],
                   ['友達に 電話を かけます。'], ['はさみで 紙を 切ります。']]),
        lambda: ['パソコンで メールを 送ります。'],
        lambda: ['私は ' + c(PERSON7) + 'と ' + c(TOGETHER7) + '。'],
        lambda: ['私は ' + c(PERSON7) + 'に ' + c(ONEWAY7) + '。'],
        # 介紹句要兩個不同的人（同一個 c() 呼叫兩次會抽到同一個）
        lambda: (lambda p: ['私は ' + p[0] + 'を ' + p[1] + 'に 紹介しました。'])(rng.sample(PERSON7, 2)),
        lambda: ['A: 誰が 紹介しましたか。', 'B: ' + c(PERSON7) + 'です。'],
        lambda: ['A: 誰に ' + c(GIFT7) + 'を あげましたか。', 'B: ' + c(PERSON7) + 'に あげました。'],
...
TMPL = {'4': rtmpl4, '5': rtmpl5, '6': rtmpl6, '7': rtmpl7}
